...
async function loadLatestNews() {
    try {
        ...
        const articles = JSON.parse(rawText.replace(/^\uFEFF/, ''));
            ...
            const articleHtml = `
                <div class="latest-news-card bg-white border" style="height: 100%; display: flex; flex-direction: column;">
                    <a href="${article.url}" class="flex-shrink-0">
                        <img class="img-fluid w-100" src="${article.image || 'img/placeholder.jpg'}" alt="${article.title}" style="height: 200px; object-fit: cover; width: 100%;" onerror="this.onerror=null;this.src='img/news-700x435-1.jpg';">
                    </a>
